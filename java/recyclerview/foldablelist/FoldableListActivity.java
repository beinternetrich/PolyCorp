package recyclerview.foldablelist;
...
import recyclerview.list.section.StickyHeaderItemDecoration;
import recyclerview.list.section.TreeNode;

/**
 * Created by per-erik on 16/11/14.
 */
public class FoldableListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(actionBar!=null) actionBar.setTitle("My Foldable List");
    }
